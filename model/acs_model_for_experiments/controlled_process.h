...
private:
    enum
    {
        ...
        KF = END_INTERFACE + 7,
        ELECROMOTIVE_FORCE = END_INTERFACE + 8,
        TORQUE = END_INTERFACE + 9,
        TORQUE_OF_LOAD = END_INTERFACE + 10,
        RESISTANCE = END_INTERFACE + 11,
        INDUCTIVITY = END_INTERFACE + 12,
        MOMENT_OF_INERTIA = END_INTERFACE + 13,
        MOMENT_OF_INERTIA_OF_ENGINE = END_INTERFACE + 14,
        MOMENT_OF_INERTIA_OF_MECHANICAL_LOAD = END_INTERFACE + 15,
